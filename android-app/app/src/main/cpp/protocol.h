/*
 * Kept identical to pc-daemon/src/protocol.h and docs/PROTOCOL.md - this is
 * the phone-side copy of the wire format so the NDK build doesn't need to
 * reach outside the Android Gradle module's source tree.
 */
